...
- Handles `lang_name == "csharp"` safely
...
- Adds C# branches in module pattern extraction and migration signal pairing

`desloppify/review/context_holistic.py`:

- Adds C# branch for mixed sync and async public API pattern checks
